        ...
        {loggedIn ?
          <div className="d-flex gap-3">
            <Link to={`/userProfile/${user.username}`}
              className="d-flex gap-2 align-items-center link-body-emphasis" style={{ cursor: 'pointer' }}>
              ...
              <p className="m-0  text-decoration-none text-uppercase">{user.username || 'unknown'}</p>
            </Link>
